...
class HeaderView: NSView {
    ...
    private func setupUI() {
        wantsLayer = true
        layer?.backgroundColor = NSColor(hex: "#2c3e50")?.cgColor
        ...
        titleLabel.textColor = NSColor(hex: "#fef5e7")
        ...
        NSLayoutConstraint.activate([
            ...
            specsPanel.trailingAnchor.constraint(equalTo: loginButton.leadingAnchor, constant: -20),
            specsPanel.centerYAnchor.constraint(equalTo: centerYAnchor),
            specsPanel.widthAnchor.constraint(equalToConstant: 200),

...
<div class="fld"><span class="lbl" contenteditable="false">Core Personality Traits <span style="font-weight:normal;color:#64748b;font-size:11px">(comma-separated for trait pills)</span></span><div class="cf" id="character-traits" contenteditable="true" data-sample="true">Reserved, intelligent, resourceful, loyal, determined, secretive</div></div>
